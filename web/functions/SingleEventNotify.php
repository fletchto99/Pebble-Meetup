...
class SingleEventNotify {
    ...
    private $exclusions = ['distance', 'id', 'name', 'venue', 'time', 'address'];
    ...
    function execute() {
        $arr = ['error' => 'Error retrieving event information to pin! Please try again later!']; //This should never happen... but...
